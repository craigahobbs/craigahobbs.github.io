...
sudo apt purge evolution gnome-calendar gnome-clocks gnome-contacts gnome-games gnome-maps gnome-music gnome-sound-recorder libreoffice* rhythmbox shotwell simple-scan totem yelp
sudo apt autoremove
